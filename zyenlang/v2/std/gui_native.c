...
static int zltk_keyword(const char* word) {
    static const char* words[] = {
        ...
        "FILE__", "FREE__", "if", "import", "let", "LIST_LEN__", "LIST_PUSH__", "LIST_SET__", "native", "null", "PRINT_CMD__", "private", "public", "recover",
        "return", "SKIP__", "spawn", "stop", "struct", "STR_TO_LIST__", "throws", "true", "TYPEOF__", "while"
    };

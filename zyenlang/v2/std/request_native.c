...
static _Thread_local char* zl_request_data = NULL;
static _Thread_local size_t zl_request_size = 0;
static _Thread_local int zl_request_code = 0;
static _Thread_local char zl_request_message[512] = "";

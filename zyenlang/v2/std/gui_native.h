...
int zl_tk_codeview_editor_text(int x, int y, int width, int height, int first_line, int line_height, int char_width, int size, int stamp, const char* lines, int selection_start_line, int selection_start_column, int selection_end_line, int selection_end_column);
